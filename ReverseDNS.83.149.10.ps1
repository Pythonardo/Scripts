$ZoneName = “83.149.10.in-addr.arpa”
...
foreach ($PTRRecordToRemove in $PTRRecordsToRemove){
    $recordName = $PTRRecordToRemove.HostName
    Remove-DnsServerResourceRecord -ComputerName DC2 -ZoneName $ZoneName -Name $recordName -RRType Ptr -Force
}