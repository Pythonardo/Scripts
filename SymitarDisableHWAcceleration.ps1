...
$userRegistryPath = "Registry::HKEY_USERS\$($currentUserSID)\SOFTWARE\Microsoft\Avalon.Graphics"
New-ItemProperty -Path $userRegistryPath -Name "DisableHWAcceleration" -Value 1 -PropertyType DWORD -Force | Out-Null