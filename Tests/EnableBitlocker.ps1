...
{
Add-BitLockerKeyProtector -MountPoint $env:SystemDrive -TpmAndStartupKeyProtector -StartupKeyPath "D:"
#Enable-BitLocker -MountPoint $env:SystemDrive -UsedSpaceOnly -RecoveryPasswordProtector -ErrorAction SilentlyContinue
}
